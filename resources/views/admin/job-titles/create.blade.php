                    ...
                    <form method="POST" action="{{ route('admin.job-titles.store') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('Название_должности') is-invalid @enderror" 
                                id="Название_должности" name="Название_должности" value="{{ old('Название_должности') }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('Описание') is-invalid @enderror" 
                                id="Описание" name="Описание" rows="3">{{ old('Описание') }}</textarea>
                            @error('Описание')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control @error('Оклад') is-invalid @enderror" 
                                id="Оклад" name="Оклад" value="{{ old('Оклад') }}" required>
                            @error('Оклад')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
