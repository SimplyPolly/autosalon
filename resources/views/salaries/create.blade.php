...
@section('content')
<div class="container">
    <h2>Добавление записи о зарплате</h2>
    ...
    <form action="{{ route('admin.salaries.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="number" step="0.01" name="base_salary" id="base_salary" class="form-control @error('base_salary') is-invalid @enderror" value="{{ old('base_salary') }}" required>
            @error('base_salary')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="number" step="0.01" name="premium" id="premium" class="form-control @error('premium') is-invalid @enderror" value="{{ old('premium', 0) }}" required>
            @error('premium')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
