...
@section('content')
<div class="container">
    <h2>Редактирование марки автомобиля</h2>
    <form action="{{ route('admin.car-brands.update', $brand) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <a href="{{ route('admin.car-brands.index') }}" class="btn btn-secondary">Отмена</a>
    </form>
</div>
@endsection 